      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className="text-center">
            <p className="text-muted-foreground text-sm mb-4">Suivez-moi</p>
            <div className="flex justify-center gap-4">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="p-3 bg-muted/30 hover:bg-primary/20 rounded-full transition-all duration-300 hover:scale-110 group"
          ...
          <div className="text-center md:text-right">
            <button
              onClick={scrollToTop}
              className="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 hover:bg-primary/20 text-primary rounded-lg transition-all duration-300 hover:scale-105"
            >
